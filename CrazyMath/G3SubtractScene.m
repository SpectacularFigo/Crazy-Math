...
@interface G3SubtractScene () <SKPhysicsContactDelegate>
...
@implementation G3SubtractScene
...
-(id)initWithSize:(CGSize)size {
    ...
    if (self = [super initWithSize:size])
    {
        ...
        NSString * stringint = [NSString stringWithFormat:@"%d",COUNT6];
    ...
    if(r == 0)
    {
        ...
        SKAction * loseAction = [SKAction runBlock:^{
            if(count6 < 10)
            {
                ...
                SKScene * g3subtractlosescene = [[G3SubtractLoseScene alloc] initWithSize:self.size won:NO];
                [self.view presentScene:g3subtractlosescene transition: reveal];
            }
            else
            {
    ...
    if([target.name  isEqual:@"target4"])
    {
        ...
        if (self.numbersDestroyed == b6)
        {
            if(count6 <= 10)
            {
                ...
                G3SubtractWinScene * g3subtractwinscene = [G3SubtractWinScene sceneWithSize:self.view.bounds.size];
                g3subtractwinscene.scaleMode = SKSceneScaleModeAspectFill;
                [self.view presentScene:g3subtractwinscene transition: reveal];
                
                SCORE6 += 10;
            }
        }
        
        else if(self.numbersDestroyed > b6)
        {
            SKTransition *reveal = [SKTransition doorsOpenHorizontalWithDuration:0.5];
            G3SubtractGameOverScene * g3subtractgameoverscene = [G3SubtractGameOverScene sceneWithSize:self.view.bounds.size];
            g3subtractgameoverscene.scaleMode = SKSceneScaleModeAspectFill;
            [self.view presentScene:g3subtractgameoverscene transition: reveal];
        }
    }
