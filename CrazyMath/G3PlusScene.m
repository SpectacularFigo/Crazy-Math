...
@interface G3PlusScene () <SKPhysicsContactDelegate>
...
-(id)initWithSize:(CGSize)size {
    ...
    if (self = [super initWithSize:size])
    {
        ...
        NSString * stringint = [NSString stringWithFormat:@"%d",COUNT5];
...
- (void)addEquation
{
    ...
    NSString * stringint1 = [NSString stringWithFormat:@"%d",a5];
    NSString * stringint2 = [NSString stringWithFormat:@"%d",b5];
    ...
    if(r == 0)
    {
        ...
        SKAction * loseAction = [SKAction runBlock:^{
            if(count5 < 10)
            {
                ...
                SKScene * g3pluslosescene = [[G3PlusLoseScene alloc] initWithSize:self.size won:NO];
                [self.view presentScene:g3pluslosescene transition: reveal];
            }
            else
            {
    ...
    if([target.name  isEqual:@"target1"])
    {
        ...
        if (self.numbersDestroyed == c5)
        {
            if(count5 <= 10)
            {
                ...
                G3PlusWinScene * g3pluswinscene = [G3PlusWinScene sceneWithSize:self.view.bounds.size];
                g3pluswinscene.scaleMode = SKSceneScaleModeAspectFill;
                [self.view presentScene:g3pluswinscene transition: reveal];
                
                SCORE5 += 10;
            }
        }
        
        else if(self.numbersDestroyed > c5)
        {
            SKTransition *reveal = [SKTransition doorsOpenHorizontalWithDuration:0.5];
            G3PlusGameOverScene * g3plusgameoverscene = [G3PlusGameOverScene sceneWithSize:self.view.bounds.size];
            g3plusgameoverscene.scaleMode = SKSceneScaleModeAspectFill;
            [self.view presentScene:g3plusgameoverscene transition: reveal];
        }
    }
